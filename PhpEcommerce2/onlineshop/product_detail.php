    ...
    <div class="container">
      ...
      <div class="row">
        ...
        <div class="col-lg-9">
          ...
          $sql = "SELECT products.*, categories.category_name FROM products INNER JOIN categories on products.product_category=categories.id WHERE product_status =1 AND products.product_category='$product_category' AND products.product_id = '$product_id'";
          $result = mysqli_query($con,$sql);

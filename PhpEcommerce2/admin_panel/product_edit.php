...
{
   header('location: ../onlineshop/registration.php');
}
?>
      ...
      <div class="row">
       ...
       <?php
          ...
          <div class="form-group">
            ...
            <input class="form-control" id="product_name" name="product_name" type="text" placeholder="" value="<?php echo $row['product_name']; ?>">
          </div>
          ...
          <div class="form-group">
            ...
            <input class="form-control" id="product_price" name="product_price" type="text" placeholder="" value="<?php echo $row['product_price']; ?>">
          </div>
          ...
          <div class="form-group">
            ...
            <input class="form-control" id="product_image" name="product_image" type="file" placeholder="">
             ...
             <img src="../<?php echo $row['product_image']; ?>"  class="my_img">
          </div>
